        ...
        do {
            ...
            if(acao==1){
                ...
                do {
                    ...
                    if (escolhaEmpresa == 1) {
                        estoqueFinalJ = (estoqueEJ - estoqueSJ) + (transferenciaP -
                                transferenciaJ);
                        if(estoqueFinalJ<=0)
                            System.out.println("Estoque zerado");
                        else
                            System.out.println("O estoque de Jatiboca e: " +
                                    estoqueFinalJ);

                    } else if (escolhaEmpresa == 2) {
                        estoqueFinalP = estoqueEP - estoqueSP + transferenciaJ -
                                transferenciaP;
                        if(estoqueFinalP<=0)
                            System.out.println("Estoque zerado");
                        else
                            System.out.println("O estoque de Pontal e: " +
                                    estoqueFinalP);
